...
const requestsByProductByStatusController = require("./src/controllers/RequestsByProductByStatusController");
...
routes.get("/requestsbytypes", requestsByProductByStatusController.index);
